...
<div className='wrapper flex-1 xxl:flex-2  flex flex-col w-auto lg:max-w-[320px] rounded-lg'>
                <CreditCard number={number} name={name} expiry={expiry} />
...
<div className="form-actions flex md:hidden my-10">
<button className="bg-[#025efe] text-white text-center m-auto w-[90%] py-3 rounded cursor-pointer">Pay Now</button>
</div>
</>
    );
};
